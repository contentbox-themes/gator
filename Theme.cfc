...
component{
	...
	// Layout Variables
    this.name       	= "ContentBox Gator Theme";
	this.description 	= "ContentBox Gator layout for ContentBox 3 based on Bootstrap 3";
    this.version        = "@build.version@+@build.number@";
	this.author 		= "Ortus Solutions";
	this.authorURL		= "httpw://www.ortussolutions.com";
